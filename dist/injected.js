...
/* harmony import */ var _metadata__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../metadata */ "./src/metadata.js");
...
function interpretLists() {
  ...
  $lists.filter(function () {
    let $list = $(this); // TO DO: This runs too often, how can I limit it?
  ...
  } else {// TO DO: Need to remobe masonry when it's no long er needed on a list
...
function createListButtons() {
  "use strict"; // The mutation won't include ".pop-over" or be it, so we have to check for somethign inside

  let $popoverHeaderTitle = $latestMutations.find(".pop-over-header-title").first(); // Bail if a list settings popup isn"t present
...
function getBoardSettings() {
  if (boardSettings == undefined) {
    Object(_generic_helpers__WEBPACK_IMPORTED_MODULE_0__["devWarning"])("BoardSettings not created. Cannot get List Settings");
    return;
  }
